...
def create_app():
    ...
    # Asegurar que exista SECRET_KEY (por si Config no la puso)
    ...
    @app.route("/")
    def index():
        # Si ya hay sesión, manda directo al dashboard correspondiente
    ...
    def internal_error(error):
        ...
        try:
            ...
            # No romper la app si falla el log en BD
            pass
